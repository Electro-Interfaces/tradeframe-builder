...
> ⚠️ Документ частично устарел. Для текущей архитектуры версии 2.1.3 используйте `docs/ARCHITECTURE_CURRENT.md`. Этот файл оставлен как расширенный исторический обзор и может содержать старые примеры тестового стека, routes и React Query API.
