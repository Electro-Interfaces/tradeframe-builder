...
> Документ требует бренд-ревизии: в проекте параллельно используются названия TradeFrame, TradeControl и TradePoint. До решения по брендингу использовать как стилевой ориентир, а не как источник названия продукта.
