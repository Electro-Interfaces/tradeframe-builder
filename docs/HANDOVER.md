...
TradeFrame / TradeControl - веб-платформа для управления сетями АЗС: оборудование, резервуары, операции, цены, смены, поступления, купоны, уведомления, пользователи, роли, юридические документы и интеграции с внешними системами.
