...
> Документ частично устарел: указанная версия 1.5.x не соответствует текущей 2.1.3. Перед изменениями PDF-экспорта сверять зависимости в `package.json` и актуальный код export-сервисов.
