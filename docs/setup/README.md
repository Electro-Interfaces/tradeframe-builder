...
Для нового разработчика начинать с `../../README.md`, `../HANDOVER.md` и `../ENVIRONMENT.md`.

| Файл | Статус |
| --- | --- |
| `QUICKSTART.md` | частично актуально |
...
| `TELEGRAM_BOT_SETUP.md` | сверять с backend runtime и secrets |
| `TELEGRAM_BOTS.md` | сверять с secrets |
| `DNS_FIX_PERMANENT.md` | история инфраструктурной настройки |
