# Руководство пользователя TradeControl Builder v1.5.31
...
TradeControl Builder — это современная веб-платформа для управления торговыми сетями АЗС. Система предоставляет:
...
Получение уведомлений в Telegram через бота **@TradeControlDW_Bot**
...
3. Вы получите ссылку вида: `https://t.me/TradeControlDW_Bot?start=ABC12XYZ`
4. **Нажмите на ссылку** или скопируйте ее в браузер
5. Telegram откроется с ботом **TradeControl Notifications**
...
9. В интерфейсе TradeControl появится статус: **"Telegram привязан: @ваш_username"**
...
**© 2024-2025 TradeControl Builder v1.5.31**
