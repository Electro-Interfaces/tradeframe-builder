...
> Исторический документ. Не использовать как текущее описание релиза или деплоя версии 2.1.3. Актуальные документы: `README.md`, `docs/deployment/DEPLOYMENT.md`, `docs/DOCS_STATUS.md`.
