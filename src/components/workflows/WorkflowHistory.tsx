...
const mockExecutions: WorkflowExecution[] = [
  {
    id: "exec-1",
    startTime: "2024-08-29T23:55:00Z",
    endTime: "2024-08-29T23:56:30Z",
    status: "success",
    triggeredBy: "schedule",
    steps: [
      {
        stepId: "step1",
        stepName: "Сформировать отчет смены",
        status: "success",
        startTime: "2024-08-29T23:55:00Z",
        endTime: "2024-08-29T23:55:45Z",
        result: "Отчеты сформированы для 5 торговых точек"
      },
      {
        stepId: "step2",
        stepName: "Закрыть смену",
        status: "success",
        startTime: "2024-08-29T23:55:45Z",
        endTime: "2024-08-29T23:56:30Z",
        result: "Смены закрыты на всех точках"
      }
    ]
  },
  {
    id: "exec-2",
    startTime: "2024-08-28T23:55:00Z",
    endTime: "2024-08-28T23:57:15Z",
    status: "error",
    triggeredBy: "schedule",
    steps: [
      {
      ...
      },
      {
        ...
        stepName: "Закрыть смену",
        status: "error",
        startTime: "2024-08-28T23:55:50Z",
        endTime: "2024-08-28T23:57:15Z",
        error: "Ошибка подключения к точке АЗС-3"
      }
    ]
  },
  {
    id: "exec-3",
    startTime: "2024-08-27T23:55:00Z",
    endTime: "2024-08-27T23:56:20Z",
    status: "success",
    triggeredBy: "schedule",
    steps: [
      {
      ...
      },
      {
        ...
        stepName: "Закрыть смену",
        status: "success",
        startTime: "2024-08-27T23:55:40Z",
        endTime: "2024-08-27T23:56:20Z",
        result: "Смены закрыты на всех точках"
      }
    ]
  ...
  {
    id: "exec-4",
    startTime: "2024-08-26T15:30:00Z",
    endTime: "2024-08-26T15:31:10Z",
    status: "success",
    triggeredBy: "manual",
    ...
    steps: [
      ...
      },
      {
        ...
        stepName: "Закрыть смену",
        status: "success",
        startTime: "2024-08-26T15:30:45Z",
        endTime: "2024-08-26T15:31:10Z",
        result: "Смены закрыты на всех точках"
      }
    ]
