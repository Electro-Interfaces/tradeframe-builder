      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-white">Количество</span>
          </div>
          {isLoading ? (
            <div className="h-7 w-16 bg-slate-700 rounded animate-pulse" />
          ) : (
            <div className="flex items-baseline gap-2">
              <span className="text-xl font-bold text-white">{safeCashout.count}</span>
              <span className="text-xs text-slate-400">инкассаций</span>
            </div>
          )}
        </div>
      </div>
              ...
              <tfoot className="bg-slate-900/50 border-t border-slate-600">
                <tr>
                  <td colSpan={3} className="px-4 py-3 text-sm font-bold text-white">
                    ИТОГО ({safeCashout.count} инкассаций)
                  </td>
