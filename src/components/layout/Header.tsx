...
export function Header({
  ...
  return (
    <header className={`${isMobile ? 'relative shadow-[0_4px_12px_rgba(0,0,0,0.05)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.4)]' : 'fixed top-0'} left-0 right-0 z-50 min-h-header bg-background border-b-0 mobile-safe-top`}>
