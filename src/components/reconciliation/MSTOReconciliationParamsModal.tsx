  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] w-[calc(100%-2rem)] max-h-[90vh] p-0 gap-0 overflow-hidden bg-slate-900 border-slate-700 flex flex-col">
        ...
        <div className="relative px-4 sm:px-6 pt-5 sm:pt-6 pb-4 sm:pb-5 bg-gradient-to-br from-cyan-600/20 via-teal-600/10 to-slate-900 flex-shrink-0">
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-cyan-500 to-teal-600 shadow-lg shadow-cyan-500/20">
              <Smartphone className="h-6 w-6 text-white" />
            </div>
            <div>
              <h2 className="text-xl font-semibold text-white">Сверка онлайн-заказов</h2>
        ...
        <div className="px-4 sm:px-6 py-4 sm:py-5 space-y-4 sm:space-y-5 flex-1 overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label htmlFor="mstoDateFrom" className="text-slate-400 text-xs font-medium mb-1.5 block">с</Label>
              ...
              <div>
                <Label htmlFor="mstoDateTo" className="text-slate-400 text-xs font-medium mb-1.5 block">по</Label>
                <div className="relative">
                  <Input
                    id="mstoDateTo"
                    type="date"
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                {allStations && (
                  <CheckCircle2 className="absolute top-2 right-2 h-4 w-4 text-cyan-400" />
                )}
                <Layers className={`h-5 w-5 mb-1.5 sm:mb-2 ${allStations ? 'text-cyan-400' : 'text-slate-500'}`} />
              ...
              >
                ...
                <Building2 className={`h-5 w-5 mb-1.5 sm:mb-2 ${!allStations ? 'text-cyan-400' : 'text-slate-500'}`} />
                <div className={`text-sm sm:text-base font-medium ${!allStations ? 'text-white' : 'text-slate-300'}`}>
                  Выбрать
                </div>
                <div className="text-xs text-slate-500 mt-0.5">
          ...
          <div className="flex items-center justify-between p-3 sm:p-4 rounded-xl bg-slate-800/30 border border-slate-700/50">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500">Включая без онлайн-заказов</div>
              </div>
            </div>
            <Switch
          ...
          <div className="p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
            <div className="flex items-start gap-2">
              <Wifi className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <Button
              ...
              className="flex-1 sm:flex-initial bg-gradient-to-r from-cyan-600 to-teal-500 hover:from-cyan-500 hover:to-teal-400
                       text-white shadow-lg shadow-cyan-500/25 sm:min-w-[140px]"
            >
              {isLoading ? (
                <>
