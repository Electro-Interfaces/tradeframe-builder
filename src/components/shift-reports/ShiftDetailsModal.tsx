          ...
          <div className={`${isMobile ? 'space-y-2' : 'space-y-4'} flex-1 overflow-y-auto`}>
              ...
              <div className={`bg-slate-700/50 rounded-lg ${isMobile ? 'p-1.5' : 'p-2.5'}`}>
                ...
                <div className={isMobile ? 'mt-0.5' : 'mt-1'}>
                  {details.status === 'open' ? (
                    ...
                    <Badge className={`bg-blue-500/10 text-blue-400 border-blue-500 flex items-center gap-1 w-fit ${isMobile ? 'text-xs' : ''}`}>
                      <CheckCircle className={isMobile ? 'w-2.5 h-2.5' : 'w-3 h-3'} />
                      Закрыта
                    </Badge>
                  ) : (
                    <Badge className={`bg-purple-500/10 text-purple-400 border-purple-500 flex items-center gap-1 w-fit ${isMobile ? 'text-xs' : ''}`}>
                      <CheckCircle className={isMobile ? 'w-2.5 h-2.5' : 'w-3 h-3'} />
                      Синхронизирована
                    </Badge>
                  )}
            ...
            <Tabs defaultValue="composition" className="w-full">
              ...
              <TabsContent value="composition" className={isMobile ? 'mt-2' : 'mt-4'}>
                <div className={`${isMobile ? 'mb-2' : 'mb-4'} text-slate-300`}>
                  ...
                  <table className={`w-full border-collapse ${isMobile ? 'text-xs' : 'text-sm'}`}>
                    <thead className="bg-slate-700/80">
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-left text-slate-100 border-r-2 border-slate-400`} rowSpan={4}>{isMobile ? 'Топливо' : 'Наименование нефтепродуктов'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={4}>{isMobile ? 'Рез.' : 'N Резервуара'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={4}>{isMobile ? 'Пл.' : 'Плотн кг/м3'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={5}>{isMobile ? 'Показания ТРК' : 'Показание счетных механизмов'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={4}>{isMobile ? 'Цена' : 'Цена за литр руб.'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={4}>{isMobile ? 'Сумма' : 'Сумма, руб.'}</th>
                        <th className={`${thClass} text-center text-slate-100`} colSpan={2}>{isMobile ? 'Погр.' : 'Погрешность ТРК'}</th>
                      </tr>
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>№ ТРК</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>{isMobile ? 'Кон.' : 'на конец смены л'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>{isMobile ? 'Нач.' : 'на начало смены л'}</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>расход</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>{isMobile ? '%' : 'проц.'}</th>
                        <th className={`${thClass} text-center text-slate-100`} rowSpan={3}>л</th>
                      </tr>
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>л</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>кг</th>
                      </tr>
                    </thead>
                    <tbody className="bg-slate-800">
                          ...
                          <React.Fragment key={fuel.fuelCode}>
                            ...
                            {nozzles.map((nozzle, nIdx) => (
                              <tr key={`${fuel.fuelCode}-${nozzle.nozzle}`} className="border-b border-slate-600">
                                {nIdx === 0 ? (
                                  <>
                                    <td className={`${tdClass} text-white font-medium border-r-2 border-slate-600`} rowSpan={nozzles.length + 1}>
                                      {fuel.fuelName}
                                    </td>
                                    <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`} rowSpan={nozzles.length + 1}>
                                      {tank?.tankNumber || '—'}
                                    </td>
                                    <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`} rowSpan={1}>
                                      {nozzle.density ? nozzle.density.toFixed(1) : '—'}
                                    </td>
                                  </>
                                ) : (
                                  <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}></td>
                                )}
                                <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{nozzle.nozzle}</td>
                                <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{nozzle.endCounter.toFixed(2)}</td>
                                <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{nozzle.startCounter.toFixed(2)}</td>
                                <td className={`${tdClass} text-center text-white font-medium border-r-2 border-slate-600`}>{nozzle.volume.toFixed(2)}</td>
                                <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{nozzle.amount.toFixed(2)}</td>
                                <td className={`${tdClass} text-center text-white font-medium border-r-2 border-slate-600`}>{nozzle.price.toFixed(2)}</td>
                                <td className={`${tdClass} text-right text-white font-medium border-r-2 border-slate-600`}>{formatCurrency(nozzle.cost)}</td>
                                <td className={`${tdClass} text-center text-slate-500 border-r-2 border-slate-600`}>0.00</td>
                                <td className={`${tdClass} text-center text-slate-500`}>0.000</td>
                              </tr>
                            ))}
                            {/* Строка "Всего:" */}
                            <tr className="border-b-2 border-slate-400 bg-slate-700/50">
                              <td className={`${tdClass} text-white font-bold`}>Всего:</td>
                              <td className={`${tdClass} border-r-2 border-slate-600`}></td>
                              <td className={`${tdClass} text-center text-white font-bold border-r-2 border-slate-600`}>{totalEndCounter.toFixed(2)}</td>
                              <td className={`${tdClass} text-center text-white font-bold border-r-2 border-slate-600`}>{totalStartCounter.toFixed(2)}</td>
                              <td className={`${tdClass} text-center text-white font-bold border-r-2 border-slate-600`}>{totalVolume.toFixed(2)}</td>
                              <td className={`${tdClass} text-center text-white font-bold border-r-2 border-slate-600`}>{totalAmount.toFixed(2)}</td>
                              <td className={`${tdClass} border-r-2 border-slate-600`}></td>
                              <td className={`${tdClass} text-right text-white font-bold border-r-2 border-slate-600`}>{formatCurrency(totalCost)}</td>
                              <td className={`${tdClass} border-r-2 border-slate-600`}></td>
                      ...
                      <tr className="border-t-2 border-slate-400 bg-slate-600">
                        <td className={`${tdClass} text-white font-bold text-lg`}>ИТОГО:</td>
                        <td className={`${tdClass} border-r-2 border-slate-400`}></td>
                        <td className={`${tdClass} border-r-2 border-slate-400`}></td>
                        <td className={`${tdClass} border-r-2 border-slate-400`}></td>
                        <td className={`${tdClass} text-center text-white font-bold border-r-2 border-slate-400`}>
                        ...
                        <td className={`${tdClass} border-r-2 border-slate-400`}></td>
                        <td className={`${tdClass} text-right text-white font-bold border-r-2 border-slate-400`}>
                ...
                <div className="overflow-x-auto rounded-lg border border-slate-600">
                  <table className={`w-full border-collapse ${isMobile ? 'text-xs' : 'text-sm'}`}>
                    <thead className="bg-slate-700/80">
                      ...
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2} rowSpan={2}>Нефтепродукты, товары</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>Прокачка<br/>л.</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>По картам</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>Скидка<br/>руб.</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>За наличные</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>Безнал.<br/>л.</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>Всего<br/>л.</th>
                        <th className={`${thClass} text-center text-slate-100`} rowSpan={2}>Разница<br/>л.</th>
                      </tr>
                      ...
                      <tr className="border-b-2 border-slate-400">
                        ...
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        ...
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}></th>
                        <th className={`${thClass} text-center text-slate-100`}></th>
                      </tr>
                    </thead>
                    <tbody className="bg-slate-800">
                      {details.salesBreakdown.map((item, idx) => (
                        <tr key={idx} className="border-b border-slate-600">
                          <td className={`${tdClass} text-white font-medium border-r-2 border-slate-600`}>{item.fuelName}</td>
                          <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{item.fuelCode}</td>
                          <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{item.pumpVolume.toFixed(2)}</td>
                          <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{item.cardVolume.toFixed(2)}</td>
                          <td className={`${tdClass} text-right text-white border-r-2 border-slate-600`}>{formatCurrency(item.cardCost)}</td>
                          <td className={`${tdClass} text-right text-white border-r-2 border-slate-600`}>{item.discountCost.toFixed(2)}</td>
                          <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{item.cashVolume.toFixed(2)}</td>
                          <td className={`${tdClass} text-right text-white border-r-2 border-slate-600`}>{formatCurrency(item.cashCost)}</td>
                          <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{item.nonCashVolume.toFixed(2)}</td>
                          <td className={`${tdClass} text-center text-white font-medium border-r-2 border-slate-600`}>{item.totalVolume.toFixed(2)}</td>
                          <td className={`${tdClass} text-center text-white`}>{item.difference.toFixed(2)}</td>
                        </tr>
                      ))}
                      {/* Строка "Всего:" */}
                      <tr className="border-t-2 border-slate-400 bg-slate-700/50">
                        <td className={`${tdClass} text-white font-bold`} colSpan={2}>Всего:</td>
                        <td className={`${tdClass} text-center text-white font-bold border-r-2 border-slate-600`}>
                        ...
                        <td className={`${tdClass} text-right text-white font-bold border-r-2 border-slate-600`}>
                        ...
                        <td className={`${tdClass} text-center text-white font-bold`}>
              ...
              <TabsContent value="tanks" className={isMobile ? 'mt-2' : 'mt-4'}>
                ...
                <div className="overflow-x-auto rounded-lg border border-slate-600">
                  <table className={`w-full border-collapse ${isMobile ? 'text-xs' : 'text-sm'}`}>
                    <thead className="bg-slate-700/80">
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-left text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>Наименование<br/>нефте-<br/>продуктов</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>N<br/>Резер-<br/>вуара</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={3}>Плотн.<br/>на<br/>начало<br/>смены<br/>г/см3</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>Книжный остаток<br/>на<br/>начало смены</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>Поступление<br/>в т.ч. прокачка</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>Расход</th>
                        <th className={`${thClass} text-center text-slate-100`} colSpan={10}>Остаток на конец смены</th>
                      </tr>
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>литры</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>кг</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>литры</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>кг</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>литры</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>кг</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>Плотн.<br/>г/см3</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>Темп<br/>C</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>общий<br/>уров.<br/>см</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>общий<br/>объем<br/>л</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>уров.<br/>воды<br/>см</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>объем<br/>воды<br/>л</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>Факт.остаток н/п.</th>
                        <th className={`${thClass} text-center text-slate-100`} colSpan={2}>расчетн.кн.ост.</th>
                      </tr>
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>литры</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>кг</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>литры</th>
                        <th className={`${thClass} text-center text-slate-100`}>кг</th>
                      </tr>
                    </thead>
                    <tbody className="bg-slate-800">
              ...
              <TabsContent value="receipts" className={isMobile ? 'mt-2' : 'mt-4'}>
                ...
                <div className="overflow-x-auto rounded-lg border border-slate-600">
                  <table className={`w-full border-collapse ${isMobile ? 'text-xs' : 'text-sm'}`}>
                    <thead className="bg-slate-700/80">
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>Нефтепродукты</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={2}>Поставщик</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>№<br/>Докум.</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} rowSpan={2}>№<br/>рез</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`} colSpan={4}>По документу</th>
                        <th className={`${thClass} text-center text-slate-100`} colSpan={4}>Фактически</th>
                      </tr>
                      <tr className="border-b-2 border-slate-400">
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Наименование</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Код</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Наименование</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Код</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Объем<br/>л</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Плотн<br/>г/см3</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Масса<br/>кг</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Темп.<br/>°C</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Объем<br/>л</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Плотн<br/>г/см3</th>
                        <th className={`${thClass} text-center text-slate-100 border-r-2 border-slate-400`}>Масса<br/>кг</th>
                        <th className={`${thClass} text-center text-slate-100`}>Темп.<br/>°C</th>
                      </tr>
                    </thead>
                    <tbody className="bg-slate-800">
                      {details.receipts.length === 0 ? (
                        ...
                        details.receipts.map((receipt, idx) => (
                          <tr key={idx} className="border-b border-slate-600">
                            <td className={`${tdClass} text-white border-r-2 border-slate-600`}>{receipt.fuelName}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.fuelCode}</td>
                            <td className={`${tdClass} text-white border-r-2 border-slate-600`}>{receipt.supplier || 'Нефтебаза'}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>1</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.documentNumber || '—'}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.tankNumber}</td>
                            {/* По документу */}
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.volume.toFixed(0)}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.density ? receipt.density.toFixed(4) : '—'}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.amount ? receipt.amount.toFixed(0) : '—'}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.temperature ? receipt.temperature.toFixed(1) : '—'}</td>
                            {/* Фактически */}
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.actualVolume ? receipt.actualVolume.toFixed(0) : receipt.volume.toFixed(0)}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.actualDensity ? receipt.actualDensity.toFixed(4) : (receipt.density ? receipt.density.toFixed(4) : '—')}</td>
                            <td className={`${tdClass} text-center text-white border-r-2 border-slate-600`}>{receipt.actualAmount ? receipt.actualAmount.toFixed(0) : (receipt.amount ? receipt.amount.toFixed(0) : '—')}</td>
                            <td className={`${tdClass} text-center text-white`}>{receipt.actualTemperature ? receipt.actualTemperature.toFixed(1) : (receipt.temperature ? receipt.temperature.toFixed(1) : '—')}</td>
                          </tr>
                        ))
                      )}
                    </tbody>
