...
export const VirtualizedOperationsTable = memo(function VirtualizedOperationsTable({
  ...
  return (
    <div className="w-full border border-slate-700 rounded-lg">
      ...
      <div
        className="overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800"
      ...
      >
        <div style={{ width: MIN_TABLE_WIDTH }}>
          ...
          {/* Тело таблицы */}
          <div style={{ height: TABLE_HEIGHT, overflowY: 'auto' }} className="scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800">
