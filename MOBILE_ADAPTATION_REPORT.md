# Отчет по мобильной адаптации TradeFrame Builder
...
TradeFrame Builder имеет **хорошо продуманную и последовательную мобильную адаптацию** с использованием современных паттернов React и адаптивного дизайна.
