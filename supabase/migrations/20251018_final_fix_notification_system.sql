-- ============================================================================
-- ФИНАЛЬНАЯ ИСПРАВЛЕННАЯ МИГРАЦИЯ СИСТЕМЫ УВЕДОМЛЕНИЙ
-- ============================================================================

-- ============================================================================
-- ШАГ 1: ОЧИСТКА - Удаляем проблемные индексы
-- ============================================================================

DROP INDEX IF EXISTS idx_notification_rules_tenant;
DROP INDEX IF EXISTS idx_notification_rules_type_active;
DROP INDEX IF EXISTS idx_user_notification_subscriptions_type;
...
-- ============================================================================
-- ШАГ 3: user_notification_subscriptions - Обновляем структуру
-- ============================================================================
...
-- Добавляем колонку enabled если её нет
...
-- Теперь создаем индекс с enabled (колонка уже существует)
